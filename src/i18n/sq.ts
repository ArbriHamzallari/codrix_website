...
export const sq: Dict = {
  locale: 'sq',
  announcement: {
    text: 'Prezantojmë Biseda AI — asistenti juaj 24/7 për klientët.',
    cta: 'Mëso më shumë',
    href: '/#si-funksionon',
  },
  nav: {
  ...
  hero: {
    title: {
      light1: 'Mbajeni biznesin tuaj',
      strong: 'hapur 24/7.',
      light2: '',
    },
    subtitle:
      'Biseda AI u përgjigjet klientëve në WhatsApp, Instagram dhe chat-in e faqes suaj, kap kërkesat, kualifikon klientët potencialë dhe rezervon takime, edhe kur ju nuk jeni aty.',
    ctaPrimary: 'Provoje falas',
    ctaSecondary: 'Shiko si funksionon',
    credibility: '9+ biznese · Shqipëri · përgjigje në ~2 sekonda',
    conversation: {
  ...
  logos: {
    title: 'Biznese reale që na kanë besuar',
    subtitle: '',
  },
  demo: {
    badge: '',
  ...
  arcadeTour: {
    ...
    subtitle: 'Nga mesazhi i parë i klientit deri te kërkesa për rezervim — brenda 90 sekondash.',
    loading: 'Duke ngarkuar demonstrimin...',
  },
  process: {
    title: 'Si filloni — vetëm 3 hapa',
    subtitle: 'Nga kontakti i parë deri te instalimi, zakonisht brenda 48–72 orëve. Nuk keni nevojë të dini asgjë teknike.',
    steps: [
      {
        title: 'Na shkruani në WhatsApp',
        text: 'Na tregoni për biznesin tuaj dhe çfarë ju nevojitet. Ne përgatisim një provë falas duke përdorur informacionet e biznesit tuaj.',
        benefits: [
          'Vetëm disa minuta për të na treguar çfarë ju nevojitet',
          'Marrim oraret, çmimet, shërbimet dhe informacionet kryesore',
          'Pa kontratë afatgjatë',
          'Pa tarifa të fshehura',
        ],
      },
      {
        title: 'Ne e përgatisim për ju',
        text: 'Asistenti përshtatet me mënyrën se si komunikon biznesi juaj, që të përgjigjet natyrshëm dhe në mënyrën që do të fliste stafi juaj.',
        benefits: [
          'Përshtatet me tonin dhe stilin e biznesit tuaj',
          'E lidhim me WhatsApp, Instagram dhe chat-in e faqes',
          'Mund të shtojmë edhe email, SMS ose Telegram sipas nevojës',
        ],
      },
      {
        title: 'Fillon t\'u përgjigjet klientëve',
        text: 'Brenda 48–72 orëve, asistenti është gati të përgjigjet në emrin e biznesit tuaj.',
        benefits: [
          'Përgjigjet klientëve 24/7',
          'Ju njofton për çdo klient dhe kërkesë të re',
          'Stafi ndërhyn vetëm kur nevojitet një person',
        ],
      },
    ],
  },
  ...
  founder: {
    ...
    paragraph:
      'AI po ndryshon mënyrën se si funksionojnë bizneset në mbarë botën. Ne besojmë se edhe bizneset shqiptare duhet të kenë akses te kjo teknologji, pa pasur nevojë për ekipe teknike apo sisteme të komplikuara.',
    closing: 'Biseda është vetëm fillimi.',
    trustHeading: 'Ndërtuar për bizneset shqiptare.',
    trustPoints: [
      {
        title: 'AI që përshtatet me mënyrën si punoni.',
        description: 'Biseda mëson informacionet, stilin dhe mënyrën e komunikimit të biznesit tuaj.',
      },
      {
        title: 'Integrim me mjetet që përdorni çdo ditë.',
        description: 'WhatsApp, Instagram, chat në faqe dhe më shumë.',
      },
      {
        title: 'Kontakt i drejtpërdrejtë.',
        description: 'Flisni drejtpërdrejt me ekipin që ndërton dhe përmirëson Biseda.',
      },
    ],
    signatureName: 'Arbri Hamzallari',
    signatureRole: 'Themelues i Biseda AI',
  ...
  problemOverload: {
    eyebrow: '',
    title: { line1: '20 mesazhe.', line2Number: 'Asnjë', line2Rest: 'klient i lënë pa përgjigje.' },
  ...
  omnichannel: {
    ...
    title: 'Një panel. Të gjitha kanalet.',
    items: [
      {
        title: 'Të gjitha bisedat e klientëve, në një vend.',
        description:
          'WhatsApp, Instagram dhe chat-i i faqes suaj bashkohen automatikisht në një panel të vetëm. Stafi juaj nuk ka nevojë të kalojë nga një aplikacion në tjetrin dhe asnjë mesazh nuk humbet.',
      },
      {
        title: 'AI u përgjigjet klientëve brenda sekondash.',
        description:
          'Asistenti AI përdor informacionet e biznesit tuaj për t\'iu përgjigjur klientëve menjëherë, 24 orë në ditë, 7 ditë në javë. Oraret, çmimet, shërbimet, pyetjet e shpeshta — Biseda i di të gjitha.',
      },
      {
        title: 'Stafi ndërhyn kur është e nevojshme.',
        description:
          'Kur një bisedë kërkon një person, stafi juaj e merr menjëherë përsipër, me gjithë historikun përpara. Klienti nuk ka nevojë të shpjegojë gjithçka nga fillimi.',
      },
    ],
  },
  action: {
  ...
  pricing: {
    ...
    subtitle: 'Paguani sipas volumit të klientëve tuaj. WhatsApp është i përfshirë në çdo plan.',
    popular: 'Më i preferuari',
    tiers: [
      {
        name: 'Starter',
        tagline: 'Për biznese të vogla që duan të mos humbin më klientë në WhatsApp.',
        features: [
          'Asistent në WhatsApp 24/7',
          'Përgjigje brenda ~2 sekondash',
          'Trajnuar me oraret, çmimet dhe shërbimet tuaja',
          'Kap emrin dhe numrin e çdo klienti të ri',
          'Instalimi i plotë nga ne',
        ],
      ...
      {
        name: 'Advanced',
        tagline: 'Për klinika dhe biznese me volum të lartë ose disa lokacione.',
        features: [
          'Gjithçka nga Growth',
      ...
      },
      {
        ...
        features: [
          'Zgjidhje e përshtatur për biznesin tuaj',
    ...
    demoPrompt: 'Dëshironi ta provoni para se të vendosni?',
    demoCta: 'Provoje falas',
    footnote: 'Shikoni si do të përgjigjej Biseda ndaj klientëve tuaj përpara se të paguani.',
  },
  faq: {
    ...
    items: [
      {
        q: 'A do ta kuptojnë klientët e mi që po flasin me AI?',
        a: 'Jo domosdoshmërisht. Biseda përshtatet me mënyrën se si komunikon biznesi juaj, duke përdorur tonin, gjuhën dhe informacionet specifike të tij. Qëllimi është që përgjigjet të duken natyrshëm, jo si tekste të gatshme.',
      },
      {
        q: 'Sa kohë duhet për ta instaluar?',
        a: 'Zakonisht 48–72 orë nga momenti që na jepni informacionet e biznesit deri sa asistenti të jetë gati për klientët tuaj.',
      },
      {
        q: 'A e ndërtoni vetë apo rishisni një platformë tjetër?',
        a: 'Biseda është ndërtuar nga ne dhe përshtatet drejtpërdrejt sipas nevojave të biznesit tuaj. Përditësimet dhe ndryshimet menaxhohen nga ekipi ynë.',
      },
      {
        q: 'Po kur pyetja është shumë e ndërlikuar?',
        a: 'Biseda e kalon automatikisht bisedën te një anëtar i ekipit tuaj, duke ruajtur të gjithë historikun. Klienti nuk ka nevojë të përsërisë veten.',
      },
      {
        q: 'A janë të sigurta të dhënat e klientëve të mi?',
        a: 'Po. Të dhënat e biznesit dhe klientëve tuaj janë të ndara nga bizneset e tjera dhe ruhen në mënyrë të sigurt.',
      },
      {
      ...
      },
      {
        ...
        a: 'Po. Biseda mund të përdoret kudo ku bizneset komunikojnë me klientët online.',
      },
      {
        q: 'Cili plan më përshtatet?',
        a: 'Varet nga numri i kanaleve, lokacioneve dhe volumit të mesazheve që merrni. Nëse nuk jeni të sigurt, na shkruani dhe do t\'ju ndihmojmë të zgjidhni planin e duhur, pa detyrim.',
      },
    ],
  },
  finalCta: {
    title: 'Mos humbisni më klientë.',
    subtitle: 'Mbajeni biznesin tuaj aktiv 24/7. Na shkruani në WhatsApp dhe brenda pak minutash ju tregojmë si do të dukej Biseda për biznesin tuaj.',
    cta: 'Na shkruani në WhatsApp',
