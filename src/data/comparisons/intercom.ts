...
const table: ComparisonGroup[] = [
  {
    ...
    rows: [
      ...
      { feature: 'WhatsApp', biseda: true, competitor: true, note: 'Intercom: kanal me pagesë sipas përdorimit, në çdo plan' },
      { feature: 'Instagram / Facebook Messenger', biseda: true, competitor: true },
      { feature: 'Thirrje telefonike (voice)', biseda: false, competitor: true, note: 'Intercom: kanal shtesë me pagesë sipas përdorimit' },
    ],
  },
  {
    ...
    rows: [
      ...
      { feature: 'Ndërtues vizual automatizimesh (workflow builder)', biseda: false, competitor: true, note: 'Intercom: vetëm plani Advanced e sipër ($85/vend/muaj)' },
  ...
  },
  {
    ...
    rows: [
      { feature: 'Konfigurimi bëhet për ju', biseda: true, competitor: false, note: 'Intercom: vetë-shërbim' },
...
export const intercomComparison: {
  slug: string;
  ...
  copy: {
    sq: {
      ...
      pillars: [
        {
          ...
          description:
            'Fin i Intercom është vetë-shërbim — disa ekipe të vogla raportojnë se u është dashur ndihmë e jashtme vetëm për ta vendosur si duhet. Ekipi i Biseda e ndërton asistentin tuaj përpara se të hyni fare.',
        },
        {
          title: 'Pa faturim për çdo rezultat',
          description:
            'Intercom faturon $0.99 për çdo bisedë të zgjidhur nga AI, mbi tarifën për vend pune (nga $29-132/vend/muaj) — kostoja rritet me ekipin dhe me volumin. Biseda është një tarifë fikse mujore me AI të përfshirë.',
        },
        {
      ...
      chooseThemTitle: 'Zgjidhni Intercom nëse…',
      chooseThem: [
      ...
      faq: [
        ...
        },
        {
          ...
          a: 'Shpesh po — konfigurimi i Intercom është vetë-shërbim, dhe ekipet e vogla raportojnë shpesh që u është dashur ndihmë e jashtme për ta konfiguruar dhe trajnuar si duhet. Ekipi i Biseda e konfiguron asistentin tuaj rreth biznesit tuaj përpara se të filloni.',
        },
        {
    ...
    en: {
      ...
      chooseThemTitle: 'Choose Intercom if…',
      chooseThem: [
