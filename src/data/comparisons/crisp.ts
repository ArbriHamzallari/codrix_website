...
const table: ComparisonGroup[] = [
  ...
  },
  {
    ...
    rows: [
      { feature: 'Konfigurimi bëhet për ju', biseda: true, competitor: false, note: 'Crisp: vetë-shërbim, me kurbë mësimi për flukse komplekse' },
...
export const crispComparison: {
  ...
  copy: {
    sq: {
      ...
      chooseThemTitle: 'Zgjidhni Crisp nëse…',
      chooseThem: [
    ...
    en: {
      ...
      chooseThemTitle: 'Choose Crisp if…',
      chooseThem: [
