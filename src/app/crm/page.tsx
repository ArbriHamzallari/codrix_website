...
import { Database, MessageCircle, CheckCircle2, ArrowLeft } from 'lucide-react';
import Link from 'next/link';

export default function CRM() {
    const whatsappNumber = '+355682061862';
    const whatsappMessage = encodeURIComponent('I\'d like to discuss installing a CRM system for my business.');
        ...
        <section className="min-h-screen pt-32 pb-20 bg-dark relative overflow-hidden">
            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <motion.div
                    ...
                    className="mb-16"
                >
                    <div className="mb-8 p-4 rounded-xl bg-primary/10 w-fit">
                        <Database className="w-12 h-12 text-primary" />
                    </div>
                    <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold font-heading mb-6 tracking-tight">
                        CRM <span className="text-gradient">Systems</span>
                    </h1>
                ...
                >
                    <h3 className="text-2xl font-bold font-heading mb-4 text-white">
                        Ready to Install Your CRM System?
                    </h3>
                    <p className="text-slate-400 mb-8 text-lg max-w-2xl mx-auto">
                        Let&apos;s discuss how a CRM system can create leverage for your business.
                    </p>
                    <button
