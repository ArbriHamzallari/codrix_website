...
import { TrendingUp, MessageCircle, CheckCircle2, ArrowLeft } from 'lucide-react';
import Link from 'next/link';

export default function Marketing() {
    const whatsappNumber = '+355682061862';
    const whatsappMessage = encodeURIComponent('I\'d like to discuss installing a marketing system for my business.');
        ...
        <section className="min-h-screen pt-32 pb-20 bg-dark relative overflow-hidden">
            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <motion.div
                    ...
                    className="mb-16"
                >
                    <div className="mb-8 p-4 rounded-xl bg-green-400/10 w-fit">
                        <TrendingUp className="w-12 h-12 text-green-400" />
                    </div>
                    <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold font-heading mb-6 tracking-tight">
                        Marketing <span className="text-gradient">Systems</span>
                    </h1>
                    <p className="text-slate-400 text-xl md:text-2xl max-w-3xl font-light leading-relaxed mb-12">
                        End-to-end marketing systems that generate, nurture, and convert leads. From awareness to revenue—fully automated and optimized for performance.
                    </p>
                </motion.div>
                ...
                >
                    <h3 className="text-2xl font-bold font-heading mb-4 text-white">
                        Ready to Install Your Marketing System?
                    </h3>
                    <p className="text-slate-400 mb-8 text-lg max-w-2xl mx-auto">
                        Let&apos;s discuss how a marketing system can generate predictable leads.
                    </p>
                    <button
