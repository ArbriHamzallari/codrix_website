...
import { Database, Zap, Bot, Users, MessageCircle, ArrowRight } from 'lucide-react';
...
const systems = [
  {
    ...
    title: 'CRM Systems',
    description:
      'Complete customer relationship management systems that track, nurture, and convert leads automatically. Built for scale, designed for results.',
  ...
  },
  {
    ...
    title: 'Automation',
    description:
      'Replace manual processes with intelligent workflows. Systems that handle operations, reduce costs, and create leverage. No human input required.',
  ...
  },
  {
    ...
    description:
      'Systems that consistently deliver high-quality leads. We build the infrastructure, you close the deals. Predictable pipeline, scalable growth.',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <button
            ...
            className="inline-flex items-center gap-3 px-10 py-5 bg-primary hover:brightness-110 text-black font-semibold rounded-full transition-all hover:scale-105 shadow-lg shadow-primary/20 text-lg"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16 max-w-5xl mx-auto">
          {systems.map((system, index) => {
            ...
            return (
              ...
              >
                {system.href ? (
                  <Link href={system.href} className={contentClassName}>
                    ...
                    <p className="text-slate-400 leading-relaxed mb-6 text-lg">{system.description}</p>
                  ...
                  <div className={cn(contentClassName, 'cursor-default')}>
                    <div className="mb-6 p-4 rounded-xl bg-white/5 w-fit group-hover:bg-white/10 transition-colors">
                      {system.icon}
                    </div>
                    <h3 className="text-2xl font-bold font-heading mb-4 text-white group-hover:text-primary transition-colors">
